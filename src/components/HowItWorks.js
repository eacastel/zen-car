  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 md:px-2 md:max-w-[750px] lg:px-6 lg:max-w-[1280px]">
        <h2
          id="how-it-works"
          className="text-4xl font-medium text-center text-white mb-2"
        >
          Our Proven 4-Step Process
        </h2>
        <h3 className="text-2xl font-medium text-center text-white mb-12">
          How We Save You{" "}
          <span className="text-white">Time, Money and Stress</span>
        </h3>
