        ...
        <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr] gap-8 md:gap-12 lg:gap-16">
          ...
          <div>
            ...
            <p className="text-secondary leading-relaxed">
              Zen Car Buying is a nationwide used car brokerage providing concierge service for stress-free purchases. Our Zen Guides help you find, evaluate, and purchase lightly used luxury and everyday vehicles — all without stepping into a dealership, saving you time, money, and stress.
            </p>
