...
export const openCalendlyPopup = async () => {
  ...
  window.Calendly.initPopupWidget({
    url: "https://calendly.com/zencarbuying/consult-internal-v3?hide_landing_page_details=1&hide_gdpr_banner=1&primary_color=f99f1b&text_color=6b8385&background_color=eaf3f3",
  });
