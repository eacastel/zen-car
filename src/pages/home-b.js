...
// Home-B specific components
import { Hero } from "../components/home-b/Hero";
import CallToAction from "../components/home-b/CallToAction";

// NEW: conversion helpers
import SocialProofStrip from "../components/home-b/SocialProofStrip";
import ServicesComparison from "../components/home-b/ServicesComparison";
import FAQ from "../components/home-b/FAQ";
import StickyMobileCTA from "../components/home-b/StickyMobileCTA";

// Lazy sections (shared)
const HowItWorks = lazy(() => import("../components/HowItWorks"));
const Testimonials = lazy(() => import("../components/Testimonials"));

// Lightweight CTA tracker
const track = (action, label, location = "home-b") => {
  try {
...
// Icon set for benefits
const icons = {
  recommendations: (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
      strokeWidth="2" stroke="currentColor" className="h-12 w-12 mx-auto mb-4">
  ...
  negotiation: (
    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24"
      strokeWidth="1" stroke="none" className="h-12 w-12 mx-auto mb-4">
...
const HomeBPage = () => {
  ...
  // Respect your existing cookie-based homepage preference
  useEffect(() => {
  ...
  return (
    <Layout>
      {/* Hero with two primary CTAs */}
      <Hero />

      {/* NEW: Social proof under hero */}
      <SocialProofStrip />
      ...
      <section className="py-16 bg-secondary" aria-labelledby="benefits-heading">
        <div className="container mx-auto px-4 md:px-2 md:max-w-[750px] lg:px-6 lg:max-w-[1280px]">
          ...
          <p className="text-2xl font-medium text-primary text-center max-w-3xl mx-auto mb-12">
            Skip the dealer hassle. We help you buy smarter—with expert guidance,
            zero pressure, and one flat fee.
          </p>
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-3 gap-12">
            {[
              ...
              {
                title: "Nationwide Vehicle Sourcing & Shipping",
                key: "sourcing",
                desc: "We find you the best deals, no matter where you live.",
              },
              {
                title: "Time Saving, Stress Free Buying",
                key: "negotiation",
                desc: "Let us do the work for you!",
              },
            ].map((benefit, index) => (
              <div
                key={index}
              ...
              >
                ...
                <Link
                  to="/services/"
                  className="inline-block mt-3 text-sm font-semibold text-primary underline-offset-4 hover:underline"
                  onClick={() => track("learn_more", benefit.title, "benefits")}
      ...
      <Suspense
        fallback={
          <div className="py-20 text-center text-primary">Loading process…</div>
        }
      >
        <HowItWorks />
      </Suspense>

      {/* NEW: Services comparison w/ clear Paid vs Free */}
      <ServicesComparison />

      {/* Testimonials (lazy, only when near viewport) */}
      ...
      {/* NEW: FAQ (lightweight, SEO-friendly) */}
      <FAQ />

      {/* Your existing CTA block.
          Ensure inside this component you place anchor IDs:
          - id="start-concierge"
          - id="start-research"
          - id="book-call"
      */}
      ...
      {/* NEW: Sticky mobile CTA bar to boost taps */}
      <StickyMobileCTA />
    </Layout>
  );
};

export default HomeBPage;

export const Head = ({ location }) => (
  <Seo
    title="Zen Car Buying | Stress-Free Concierge Service for New & Lightly Used Cars"
    description="Zen Car Buying is your trusted concierge for finding lightly used and luxury vehicles nationwide. Clear pricing, expert negotiation, and zero dealer hassle."
    pathname={location?.pathname || "/home-b"}
  >
