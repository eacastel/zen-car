    ...
    <Layout>
      ...
      >
        ...
        <p className="text-lg text-gray-500 mb-12">
          Your Trusted Nationwide Car Broker Concierge Service
        </p>
        ...
        <section className="mb-12">
          ...
          <p className="text-base md:text-lg text-primary mb-4">
            At <strong>Zen Car Buying</strong>, we simplify the car-buying
            experience—whether you're shopping for a <strong>brand-new</strong>{" "}
            vehicle or a <strong>lightly used car</strong>. As a{" "}
            <strong>nationwide car broker concierge service</strong>, we
            leverage years of expertise and modern tools to ensure you get the
            right car without the time, stress, or dealership pressure.
          </p>
          <p className="text-base md:text-lg text-primary mb-4">
            Our <strong>Zen Guides</strong> exclusively represent your
            interests.Unlike traditional or “free” car brokers who take
            kickbacks from dealers, we work only for you. From research to
            negotiation and delivery, we help you purchase the best{" "}
            <strong>new or used vehicle</strong>—at the best possible price.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <p className="text-base md:text-lg text-primary mb-4">
                Zen Car Buying serves customers across the{" "}
                <strong>continental U.S.</strong>, sourcing both new and used
                vehicles from markets that offer the best value. This often
                means thousands in savings over your local dealership. Wherever
                you're located, we coordinate every detail—from search to{" "}
                <strong>seamless home delivery</strong>.
              </p>
            </div>
            <div>
              <GatsbyImage
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <ul className="list-disc pl-5 space-y-2 text-base md:text-lg text-primary">
                <li>
                  Personalized new and used vehicle recommendations tailored to
        ...
        <section className="mb-12">
          ...
          <p className="text-base md:text-lg text-primary leading-relaxed mb-6 max-w-3xl">
            We make car buying simple and stress-free—no dealer games, no wasted
            time. Just expert help and one flat fee, with your best deal as our
            only goal.
          </p>
            ...
            {[
              {
                ...
                desc: (
                  <>
                    Choose a service package and book your onboarding call to
                    get started —or book a{" "}
                    <button
                      type="button"
                      onClick={e => {
                        e.preventDefault()
        ...
        <section className="mb-12">
          ...
          <p className="text-base md:text-lg text-primary leading-relaxed max-w-2xl mb-6">
            Your free 15-minute call is pressure-free and designed to help you
            understand how we work, what you'll get, and whether a full-service
            or à la carte option makes the most sense for your situation. Click{" "}
            <button
              type="button"
              onClick={e => {
                e.preventDefault()
        ...
        <section className="mb-12">
          ...
          <p className="text-base md:text-lg text-primary">
            Most recommended used vehicles are still under the{" "}
            <strong>original manufacturer warranty</strong> and many new cars
            qualify for <strong>extended coverage</strong>. We help ensure your
            purchase is as worry-free as it is cost-effective.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-base md:text-lg text-primary mb-4">
            Whether you're seeking a dependable used car or a brand-new luxury
            vehicle, Zen Car Buying is your trusted partner for{" "}
            <strong>stress-free car broker services</strong>.
          </p>
          <p className="text-base md:text-lg text-primary mb-4">
