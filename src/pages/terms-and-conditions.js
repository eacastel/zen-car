  ...
  return (
    <Layout>
      <main className="container mx-auto py-10 px-6 lg:px-12">
        <h1 className="text-primary text-4xl font-bold my-8">Website Terms and Conditions</h1>
        ...
        <section className="space-y-6 text-primary">
          <p>
            Welcome to the website of <strong>Zen Car Buying, LLC</strong> (“ZCB”, “Company”, “we”, or “us”). By accessing or using this website (the “Site”), you agree to be bound by the following Website Terms and Conditions (“Terms”). If you do not agree to these Terms, please do not use this Site.
          </p>
